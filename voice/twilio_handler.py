...
class TwilioHandler:
    ...
    async def handle_incoming_call(self, form_data: dict) -> VoiceResponse:
        ...
        try:
            ...
            # **RESTORE ELEVENLABS** - Generate high-quality audio for greeting
            try:
                ...
                if greeting_url:
                    ...
                    # Fallback to Twilio TTS only if audio serving fails
    ...
    async def handle_voice_input(self, form_data: dict) -> VoiceResponse:
        ...
        try:
            ...
            # **RESTORE ELEVENLABS** - Generate high-quality audio for AI response
            try:
            ...
            if should_continue:
                ...
                try:
                    ...
                    if goodbye_url:
                        ...
                        print(f"✅ Playing ElevenLabs goodbye from: {goodbye_url}")
                    else:
                        response.say(goodbye_text)
                        print("❌ Goodbye audio URL failed, using fallback TTS")
                except Exception as e:
                    print(f"❌ ElevenLabs goodbye failed: {e}")
